...
<form id="peak-15-form" name="signup-form-general" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">

    <input type="hidden" name="formname" value="Sign-Up Form">
    <input type="hidden" name="pagename" value="">
    <input type="hidden" name="statuscode" value="Request Completed">
    <input type="hidden" name="catalogrequest" value="1">
    <input type="hidden" name="ruletype" value="Contacts with same First Name Email" />
